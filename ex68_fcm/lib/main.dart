...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Ex68 FCM'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    FirebaseMessaging.instance
      .getToken(vapidKey:
        'feWGFh6wTOK4FXusHN3rhe:APA91bHFEKkOZ0Hr5QLUoityVAxFaEpW7YCXLxx2psZgdiWIs29hX7A0c-LIHLtSqIs-f7oqDFok-4TlT166OeIl1sebh9Fl44CYTu3-90Gc7-fkh9_1qgFd6p-D3yKYDTtcpODuz5HL')
      .then(setToken);
